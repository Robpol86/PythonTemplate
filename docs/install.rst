...
The easiest way to get PythonTemplate is to use `pip <https://pip.pypa.io>`_. Simply run this command.
...
.. code-block:: bash
    ...
    pip install git+https://github.com/Robpol86/PythonTemplate.git

Clone and Install
=================

Lastly you can also just clone the repo and install from it. Usually you only need to do this if you plan on
`contributing <https://github.com/Robpol86/PythonTemplate/blob/master/CONTRIBUTING.md>`_ to the project.
